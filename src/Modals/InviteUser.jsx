    ...
    <div className="invite-user-modal modal" ref={modal}>
      <div className="modal-container">
        <div className="modal-content modal-open" ref={modalContent}>
          <button class="invite-user-content-close close" onClick={handleClose}>
            &times;
          </button>
          ...
          <form>
            <div className="invite-user__form-name my-2">
              ...
              <input type="text" placeholder="Please enter your full name" className="primary__input my-1" />
            </div>
            <div className="invite-user__form-email my-2">
              <label className="text-sm">Email</label>
              <input type="email" placeholder="Please enter your email" className="primary__input my-1" />
            </div>
