        ...
        <div className="cookie-modal modal" ref={modal}>
            <div className="modal-container">
                <div className="modal-content modal-open" ref={modalContent}>
                    <button
                        class="cookie-content-close close"
                        onClick={handleClose}
                    >
                        &times;
                    </button>
                    ...
                    <div className="cookie-modal__subheading">
                        <p>
                            We use cookies to personalize and enhance your
                            experience on our site and improve the delivery of
                            ads to you. Visit our{' '}
                            <span className="text-orange-500">
                                Cookie Policy
                            </span>{' '}
                            to learn more. By clicking "accept", you agree to
                            our use of cookies.
                        </p>
                    </div>
