    ...
    <div className="choose-storage-modal modal" ref={modal}>
      <div className="modal-container">
        <div className="modal-content modal-open" ref={modalContent}>
          <button class="choose-storage-content-close close" onClick={handleClose}>
            &times;
          </button>
          ...
          <div className="choose-storage-modal__subheading">
            Are you sure you want to select the <span>“Lorem Ipsum”</span> storage?
          </div>
          ...
          <div className="choose-storage-modal__actions">
            ...
            <button className="primary__button">YES</button>
          </div>
        </div>
      </div>
    </div>
