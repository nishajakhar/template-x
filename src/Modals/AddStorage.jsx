import '../styles/Modals/AddStorage.scss';
...
export default function AddStorageModal(props) {
    ...
    return (
        <div className="add-storage-modal modal" ref={modal}>
            <div className="modal-container">
                <div className="modal-content modal-open" ref={modalContent}>
                    <button
                        class="add-storage-content-close close"
                        onClick={handleClose}
                    >
                        &times;
                    </button>
                    <div className="add-storage-modal__heading">
                        <h1>New Storage</h1>
                    </div>

                    <form>
                        <div className="add-storage__form-input">
                            <label className="">Name Storage</label>
                            <input
                                type="text"
                                placeholder="Please enter name storage"
                        ...
                        <div className="add-storage__form-subheading">
                        ...
                        <div className="add-storage__form-input">
                            ...
                            <input
                                type="text"
                                placeholder="Please enter bucket assigned name"
                                className="primary__input my-2"
                            />
                        </div>
