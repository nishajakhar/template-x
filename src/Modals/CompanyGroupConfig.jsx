        ...
        <div className="company-group-config-modal modal" ref={modal}>
            <div className="modal-container">
                <div className="modal-content modal-open" ref={modalContent}>
                    <button
                        class="company-group-config-content-close close"
                        onClick={handleClose}
                    >
                        &times;
                    </button>
                    ...
                    <form>
                        ...
                        <div className="company-group-config__form-properties">
                            ...
                            <div className="company-group-config__form-property-item">
                                <input type="checkbox" className="" />
                                <label className="">
                                    Lectus in lectus massa non in donec ultrices
                                    arcu habitant.{' '}
                                </label>
                            </div>
                            <div className="company-group-config__form-property-item">
                            ...
                            <div className="company-group-config__form-property-item">
                                <input type="checkbox" className="" />
                                <label className="">
                                    Quis interdum metus netus amet dolor nunc,
                                    odio.
                                </label>
                            </div>
                            <div className="company-group-config__form-property-item">
                            ...
                            <div className="company-group-config__form-property-item">
                                <input type="checkbox" className="" />
                                <label className="">
                                    Eget vivamus aliquet ornare quis mauris,
                                    scelerisque magna felis.
                                </label>
                            </div>
