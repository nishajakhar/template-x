    ...
    <div className="adblock-modal modal" ref={modal}>
      <div className="modal-container">
        <div className="modal-content modal-open" ref={modalContent}>
          <button class="adblock-content-close close" onClick={handleClose}>
            &times;
          </button>
          ...
          <div className="adblock-modal__subheading">
            <p>
              Through AdBlock, the ad part of the site may not be displayed correctly. Please disable the blocker or add
              the current page or site completely to the exclusion. Or just turn off AdBlock. Thank you!
            </p>
          </div>
