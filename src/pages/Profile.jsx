                ...
                <div className="profile__container">
                    <div className="profile__form">
                        <div className="profile__form-heading mb-5">
                            <h1 className="profile__form-heading__text">
                                Profile Information
                            </h1>
                        </div>
                        <form>
                            ...
                            <div className="profile__form-inputs flex my-12 pricing-plan">
                    ...
                    <div className="profile__invoices__mobile">
                        <h1>Invoices</h1>
                        <InvoiceMobile invoices={invoices} />
                    </div>
...
function InvoiceMobile({ invoices }) {
    return (
        <div className="invoices__mobile">
            {invoices.map(item => (
                <div className="invoices__mobile__items">
                    <div className="invoices__mobile__title">
                        <p>Description</p>
                        <p>Date</p>
                        <p>Price</p>
                        <p>Payment Method</p>
                    </div>
                    <div className="invoices__mobile__value__outer">
                        <div className="invoices__mobile__value__inner">
