...
export default function StorageDetailScreen() {
    ...
    return (
        <>
            {open && <EditStorageModal open={setOpen} />}
                ...
                <div className="storage-detail">
                    ...
                    <div className="storage-detail__container">
                        <div className="storage-detail__header">
                            ...
                            <div className="storage-detail__header-info">
                                ...
                                <div className="storage-detail__header-description">
                                    <p>
                                        Individual Subscription to lorem ipsum
                                        for 1 month USD 150
                                    </p>
                                </div>
                            </div>
                            <div
                                className="storage-detail__header-button flex gap-2 cursor-pointer"
                        ...
                        <div className="storage-detail__main">
                            ...
                            <p className="">
                                You have purchased such a subscription for 1
                                month
                            </p>
                        </div>
                        ...
                        <div className="storage-detail__disclaimer">
                            <p>
                                If you cancel now, untill July 9, 2022, you will
                                still be able to use the subscription
                            </p>
                        </div>
                    </div>
